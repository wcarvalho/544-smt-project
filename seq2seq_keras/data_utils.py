...
def data_to_token_ids(data_path, target_path, vocabulary_path,
                      tokenizer=None, normalize_digits=True, quick_and_dirty=False):
...
def prepare_wmt_data(data_dir, en_vocabulary_size, fr_vocabulary_size, tokenizer=None, quick_and_dirty=False):
  ...
  Args:
    ...
    tokenizer: a function to use to tokenize each data sentence;
      if None, basic_tokenizer will be used.
    quick_and_dirty: Boolean; turn on tricks to get quick & dirty results, e.g. stopping in creating the vocabulary early
